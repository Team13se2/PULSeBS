...
export default [
...

  {
    id: 4,
    title: 'Some Event',
    start: new Date(2020, 12, 9, 0, 0, 0),
    end: new Date(2020, 12, 10, 0, 0, 0),
  },
  {
    id: 5,
    title: 'Conference',
    start: new Date(2020, 12, 11),
  ...
  },
  {
    id: 6,
    title: 'Meeting',
    start: new Date(2020, 12, 12, 10, 30, 0, 0),
    end: new Date(2020, 12, 12, 12, 30, 0, 0),
    desc: 'Pre-meeting meeting, to prepare for the meeting',
  },
  {
    id: 7,
    title: 'Lunch',
    start: new Date(2020, 12, 12, 12, 0, 0, 0),
    end: new Date(2020, 12, 12, 13, 0, 0, 0),
    desc: 'Power lunch',
  },
  {
    id: 8,
