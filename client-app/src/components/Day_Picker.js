...
class Day_Picker extends React.Component {
  state = {
  ...
  handleDayChange = date => {
    ...
    this.props.selectWeek(getWeekDays(getWeekRange(date).from)[0],getWeekDays(getWeekRange(date).to)[0]);
  };
