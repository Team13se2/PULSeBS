              ...
              <Modal isOpen={modalIsOpen} onRequestClose={closeModal} style={customStyles}>
                ...
                <>
                  ...
                  {students && students.map((student,index) =>(
                    ...
                    <td>{student.name}</td>
                    <td>{student.surname}</td>
                    <td>{student.email} <button type="button" className="btn btn-success" style={{visibility: "hidden"}} disabled={student.presence} onClick={()=>setPresence(student.id,lecture_id)}>Present 
                    </button></td>
                    </tr>
                  ))}        
                  </tbody>
